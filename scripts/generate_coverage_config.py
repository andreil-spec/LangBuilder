...
def main():
    ...
    backend_components_path = project_root / "src" / "backend" / "base" / "langbuilder" / "components"
    ...
    print("cd src/backend && python -m pytest --cov=src/backend/base/langbuilder --cov-config=.coveragerc")
