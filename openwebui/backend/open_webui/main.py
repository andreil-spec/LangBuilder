...
# OAuth Service Authorization routers
from open_webui.routers import services, google_drive, zoho_people, intrasearch
...
# IntraSearch router (independent from LLM providers)
...
async def get_opensearch_xml():
    ...
    <Image width="16" height="16" type="image/x-icon">favicon.png</Image>
