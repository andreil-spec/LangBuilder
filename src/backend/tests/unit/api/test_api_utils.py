...
from langbuilder.api.utils import get_suggestion_message
from langbuilder.services.database.models.flow.utils import get_outdated_components
...
def test_get_outdated_components():
    ...
    with patch(
        "langbuilder.services.database.models.flow.utils.get_components_versions", return_value=mock_component_versions
    ):
