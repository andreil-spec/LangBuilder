...
import pytest
from langbuilder.components.vectorstores.local_db import LocalDBComponent
from langbuilder.schema.data import Data
from langbuilder.services.cache.utils import CACHE_DIR
...
class TestLocalDBComponent(ComponentTestBaseWithoutClient):
    ...
    @patch("langbuilder.components.vectorstores.local_db.LocalDBComponent.list_existing_collections")
