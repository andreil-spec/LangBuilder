...
import pytest
from langbuilder.components.youtube.youtube_transcripts import YouTubeTranscriptsComponent
from langbuilder.schema import Data, DataFrame, Message
...
class TestYouTubeTranscriptsComponent(ComponentTestBaseWithoutClient):
    ...
    @patch("langbuilder.components.youtube.youtube_transcripts.YoutubeLoader")
