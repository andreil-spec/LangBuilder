...
from langbuilder.base.langwatch.utils import get_cached_evaluators
from langbuilder.components.langwatch.langwatch import LangWatchComponent
...
class TestLangWatchComponent(ComponentTestBaseWithoutClient):
    ...
    @patch("langbuilder.components.langwatch.langwatch.httpx.get")
