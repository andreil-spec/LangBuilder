...
class TestComponentLoading:
    ...
    async def test_component_loading_performance_comparison(self, base_components_path):
        ...
        # Both should complete in reasonable time (< 5s for langbuilder, < 15s for all_types)
        assert langbuilder_duration < 5.0, f"get_langbuilder_components_list took too long: {langbuilder_duration}s"
    ...
    async def test_result_structure_comparison(self, base_components_path):
        ...
        print("\nComponent Counts:")
        print(f"get_langbuilder_components_list: {langbuilder_count} components")
        print(f"aget_all_types_dict: {all_types_count} components")

        # get_langbuilder_components_list should always return built-in components
        assert langbuilder_count > 0, "Should have built-in Langbuilder components"
    ...
    async def test_comprehensive_performance_summary(self, base_components_path):
        ...
        assert avg_langbuilder < 5.0, f"Steady-state performance should be under 5s, got {avg_langbuilder:.4f}s"
    ...
    async def test_component_differences_analysis(self, base_components_path):
        ...
        assert langbuilder_count > 0, "import_langbuilder_components should return components"
