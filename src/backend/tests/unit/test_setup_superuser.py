...
from langbuilder.services.settings.constants import (
    DEFAULT_SUPERUSER,
...
# @patch("langbuilder.services.deps.get_session")
# @patch("langbuilder.services.utils.create_super_user")
# @patch("langbuilder.services.deps.get_settings_service")
# # @patch("langbuilder.services.utils.verify_password")
...
async def test_create_super_user_race_condition():
    ...
    with (
        patch("langbuilder.services.auth.utils.get_user_by_username", mock_get_user_by_username),
        patch("langbuilder.services.auth.utils.get_password_hash", mock_get_password_hash),
        patch("langbuilder.services.database.models.user.model.User") as mock_user_class,
    ):
...
async def test_create_super_user_race_condition_no_user_found():
    ...
    with (
        patch("langbuilder.services.auth.utils.get_user_by_username", mock_get_user_by_username),
        patch("langbuilder.services.auth.utils.get_password_hash", mock_get_password_hash),
        patch("langbuilder.services.database.models.user.model.User", return_value=mock_user),
...
async def test_create_super_user_concurrent_workers():
    ...
    with patch("langbuilder.services.auth.utils.get_user_by_username", mock_get_user_by_username):
