...
from langbuilder.services.store.exceptions import APIKeyError, FilterError, ForbiddenError
from langbuilder.services.store.schema import (
...
from langbuilder.services.store.utils import (
...
def get_id_from_search_string(search_string: str) -> str | None:
    ...
    if "www.langbuilder.store/store/" in search_string:
...
class StoreService(Service):
    """This is a service that integrates langbuilder with the store which is a Directus instance.
