...
from langbuilder.interface.utils import extract_input_variables_from_prompt
...
if TYPE_CHECKING:
    from langbuilder.api.v1.schemas import ResultDataResponse
...
def has_chat_output(vertices: dict[Vertex, int]):
    from langbuilder.graph.schema import InterfaceComponentTypes
