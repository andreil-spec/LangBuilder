...
def create_langbuilder_progress(*, verbose: bool = False) -> ProgressIndicator:
    """Create a progress indicator with predefined Langbuilder initialization steps."""
    progress = ProgressIndicator(verbose=verbose)

    # Define the initialization steps matching the order in main.py
    steps = [
        ("Initializing Langbuilder", "Setting up basic configuration"),
        ...
        ("Launching Langbuilder", "Starting server and final setup"),
    ]
...
def create_langbuilder_shutdown_progress(*, verbose: bool = False, multiple_workers: bool = False) -> ProgressIndicator:
    """Create a progress indicator with predefined Langbuilder shutdown steps."""
    progress = ProgressIndicator(verbose=verbose)
