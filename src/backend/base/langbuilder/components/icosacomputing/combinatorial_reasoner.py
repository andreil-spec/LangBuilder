...
from langbuilder.base.models.openai_constants import OPENAI_CHAT_MODEL_NAMES
from langbuilder.custom.custom_component.component import Component
from langbuilder.inputs.inputs import DropdownInput, SecretStrInput, StrInput
...
class CombinatorialReasonerComponent(Component):
    ...
    def build_prompt(self) -> Message:
        ...
        response = requests.post(
            "https://cr-api.icosacomputing.com/cr/langbuilder",
            json=params,
            auth=creds,
            timeout=100,
        )
