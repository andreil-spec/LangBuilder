...
from langbuilder.inputs.inputs import BoolInput, DropdownInput, FloatInput, IntInput, MessageTextInput, SecretStrInput
...
class NvidiaIngestComponent(BaseFileComponent):
    ...
    try:
        ...
        msg = (
            ...
            "Please install them using your package manager. (e.g. uv pip install langbuilder[nv-ingest])"
        )
