...
from langbuilder.io import DictInput, IntInput, SecretStrInput, StrInput, TableInput
...
class AstraDBCQLToolComponent(LCToolComponent):
    ...
    documentation: str = "https://docs.langbuilder.org/Components/components-tools#astra-db-cql-tool"
    icon: str = "AstraDB"
