...
from langbuilder.base.tools.run_flow import RunFlowBaseComponent
from langbuilder.helpers.flow import run_flow
...
class RunFlowComponent(RunFlowBaseComponent):
    ...
    documentation: str = "https://docs.langbuilder.org/components-logic#run-flow"
    beta = True
    name = "RunFlow"
    icon = "Workflow"
