...
from langbuilder.inputs.inputs import SecretStrInput, StrInput
...
class HomeAssistantControl(LCToolComponent):
    ...
    # --- Input fields for LangBuilder UI (token, URL) ---
    inputs = [
        SecretStrInput(
            name="ha_token",
    ...
    def run_model(self) -> Data:
        """Used when the 'Run' button is clicked in LangBuilder.
    ...
    def _make_data_response(self, result: dict[str, Any] | str) -> Data:
        """Returns a response in the LangBuilder Data format."""
