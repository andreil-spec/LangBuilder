...
from langbuilder.io import BoolInput, DropdownInput, IntInput, MessageTextInput, Output, SliderInput, TableInput
...
class URLComponent(Component):
    ...
    documentation: str = "https://docs.langbuilder.org/components-data#url"
