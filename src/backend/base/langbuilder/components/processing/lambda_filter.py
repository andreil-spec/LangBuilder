...
from langbuilder.io import DataInput, HandleInput, IntInput, MultilineInput, Output
from langbuilder.schema.data import Data
from langbuilder.utils.data_structure import get_data_structure
...
class LambdaFilterComponent(Component):
    ...
    documentation: str = "https://docs.langbuilder.org/components-processing#smart-function"
