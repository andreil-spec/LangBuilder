...
from langbuilder.inputs import DictInput, DropdownInput, MessageTextInput, SortableListInput
...
class DataOperationsComponent(Component):
    ...
    documentation: str = "https://docs.langbuilder.org/components-processing#data-operations"
    icon = "file-json"
    name = "DataOperations"
