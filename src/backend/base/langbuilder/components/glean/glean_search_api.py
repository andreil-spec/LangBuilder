...
from langbuilder.inputs.inputs import IntInput, MultilineInput, NestedDictInput, SecretStrInput, StrInput
...
class GleanAPIWrapper(BaseModel):
    ...
    act_as: str = "langbuilder-component@datastax.com"  # TODO: Detect this
...
class GleanSearchAPIComponent(LCToolComponent):
    ...
    documentation: str = "https://docs.langbuilder.org/Components/components-tools#glean-search-api"
    icon: str = "Glean"
