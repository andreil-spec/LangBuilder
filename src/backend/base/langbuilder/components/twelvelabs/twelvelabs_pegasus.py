...
from langbuilder.inputs import DataInput, DropdownInput, MessageInput, MultilineInput, SecretStrInput, SliderInput
...
class TwelveLabsPegasus(Component):
    ...
    documentation = "https://github.com/twelvelabs-io/twelvelabs-developer-experience/blob/main/integrations/Langbuilder/TWELVE_LABS_COMPONENTS_README.md"
