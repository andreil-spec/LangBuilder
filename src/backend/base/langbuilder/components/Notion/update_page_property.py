...
from langbuilder.inputs.inputs import MultilineInput, SecretStrInput, StrInput
...
class NotionPageUpdate(LCToolComponent):
    ...
    documentation: str = "https://docs.langbuilder.org/integrations/notion/page-update"
