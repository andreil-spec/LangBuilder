...
from langbuilder.components.data import URLComponent
from langbuilder.components.input_output import ChatOutput, TextInputComponent
from langbuilder.components.openai.openai_chat_model import OpenAIModelComponent
from langbuilder.components.processing import ParserComponent, PromptComponent
...
""")
    ...
    url_component.set(urls=["https://langbuilder.org/", "https://docs.langbuilder.org/"])
    ...
    text_input.set(
        input_value="Use the references above for style to write a new blog/tutorial about Langbuilder and AI. "
