...
# it means uvicorn's /health serves first before the langbuilder instance is up
# therefore it's not a reliable health check for a langbuilder instance
...
# It's a reliable health check for a langbuilder instance
