...
from langbuilder.api.utils import CurrentActiveUser, check_langbuilder_version
from langbuilder.services.auth import utils as auth_utils
from langbuilder.services.deps import get_settings_service, get_store_service
from langbuilder.services.store.exceptions import CustomError
...
async def share_component(
    ...
    try:
        await check_langbuilder_version(component)
