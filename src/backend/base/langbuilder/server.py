...
from langbuilder.logging.logger import InterceptHandler


class LangbuilderUvicornWorker(UvicornWorker):
...
class LangbuilderApplication(BaseApplication):
    def __init__(self, app, options=None) -> None:
        self.options = options or {}

        self.options["worker_class"] = "langbuilder.server.LangbuilderUvicornWorker"
