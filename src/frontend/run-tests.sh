...
# Start the backend
LANGBUILDER_DATABASE_URL=sqlite:///./temp LANGBUILDER_AUTO_LOGIN=True poetry run langbuilder run --backend-only --port 7860 --host 0.0.0.0 --no-open-browser > /dev/null 2>&1 &
